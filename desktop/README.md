...
This **`next`** tree is **`1.2.0-beta.1`** (NSIS only). Download the signed
installer from the [beta release](https://github.com/blocksdevpro/boris-assistant/releases/tag/v1.2.0-beta.1).
