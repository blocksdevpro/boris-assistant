          ...
          {STATUS_FIXTURES.map((item) => {
            ...
            <section key={item.name} className="min-w-0">
              <div className="mb-2 flex items-baseline justify-between gap-3 px-1">
                ...
                >
                  {card ? "Open at 400 × 300" : "Open at 380 × 120"}
                </a>
              </div>
              <iframe
                ...
                className={
                  card
                    ? "block h-[300px] w-[400px] overflow-hidden rounded-lg border border-white/10 bg-black shadow-xl"
                    : "block h-[160px] w-[380px] overflow-hidden rounded-lg border border-white/10 bg-black shadow-xl"
                }
              />
            </section>
            );
