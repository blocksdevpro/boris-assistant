    ...
    <main className="min-h-screen bg-[#111114] px-6 py-8 text-white">
      <div className="mx-auto max-w-[1280px]">
        ...
        <p className="mt-1 text-sm text-white/55">
          Deterministic browser-only states · frame viewport 380 × 160
        </p>
          ...
          {STATUS_FIXTURES.map((item) => (
            <section key={item.name} className="min-w-0">
              ...
              <iframe
                ...
                className="block h-[160px] w-[380px] overflow-hidden rounded-lg border border-white/10 bg-black shadow-xl"
              />
            </section>
          ))}
        </div>
